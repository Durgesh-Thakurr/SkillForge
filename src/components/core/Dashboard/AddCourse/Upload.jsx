  ...
  return (
    <div className="flex flex-col space-y-2">
      ...
      <div
        ...
        } flex min-h-[250px] cursor-pointer items-center justify-center rounded-md border-2 border-dashed border-richblack-500 transition-all duration-200`}
      >
        <input {...getInputProps()} />
          ...
          <div className="flex w-full flex-col p-6">
            ...
            {!viewData && (
              <button
                ...
                className="mt-3 text-sm text-richblack-300 underline hover:text-red-400"
              >
                Remove
              </button>
            )}
