exports.contactUsEmail = (
  ...
  <head>
      ...
      <style>
          ...
          .cta { display: inline-block; padding: 10px 20px; background-color: #EAB308; color: #000000; text-decoration: none; border-radius: 5px; font-size: 16px; font-weight: bold; margin-top: 20px; }
  ...
  <body>
      <div class="container">
          ...
          <div class="support">If you have any further questions or need immediate assistance, please feel free to reach out to us at <a href="mailto:dev.wworkss@gmail.com">dev.wworkss@gmail.com</a>. We are here to help!</div>
      </div>
  </body>
  </html>`
} 