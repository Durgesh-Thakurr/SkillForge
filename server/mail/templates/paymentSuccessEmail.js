exports.paymentSuccessEmail = (name, amount, orderId, paymentId) => {
  ...
  <body>
      <div class="container">
          ...
          <div class="support">If you have any questions or need assistance, please feel free to reach out to us at <a href="mailto:dev.wworkss@gmail.com">dev.wworkss@gmail.com</a>. We are here to help!</div>
      </div>
  </body>
  </html>`
} 